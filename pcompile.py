...
if sys.platform == 'darwin':
    ...
    subprocess.check_call('rsync ./comixngn.min.js ./wordpress/comixngn/js/comixngn.min.js')
    subprocess.check_call('zip -j -r foo foo ./wordpress/comixngn.zip ./wordpress/comixngn')
